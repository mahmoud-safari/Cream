...
mkdir '$DATA_PATH/train' && cp ILSVRC2012_img_train.tar '$DATA_PATH/train/' && cd '$DATA_PATH/train'
...
mkdir '$DATA_PATH/val' && cp ILSVRC2012_img_val.tar '$DATA_PATH/val/' && cd '$DATA_PATH/val' && tar -xvf ILSVRC2012_img_val.tar && rm -f ILSVRC2012_img_val.tar
